...
def search_places():
    ...
    if not data or not any([data.get('states'), data.get('cities'), data.get('amenities')]):
    ...
    if amenities:
        ...
        place_list = [place for place in place_list if all([amenity in place.amenities for amenity in amenities])]
